...
export const createShiftSchedule = catchAsyncError(async (req, res, next) => {
...
export const addStaffMember = catchAsyncError(async (req, res, next) => {
...
export const assignStaffToShifts = catchAsyncError(async (req, res, next) => {
...
export const viewShiftDetails = catchAsyncError(async (req, res, next) => {
    const { date } = req.body;
    if (!date) {
        return next(new ErrorHandler("Bad Request", 400));
    }
...
export const updateShiftDetails = catchAsyncError(async (req, res, next) => {
